...
const about = () => {
  return (
    <>
      <Head>
        <title> NGOC NV | About Page </title>
      ...
      <main className="flex items-center flex-col w-full justify-center dark:text-light">
        <Layout className="pt-16">
          <AnimatedText
            ...
            className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl mb:!text-8"
          />
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I'm NGOC NV, a web developer and UI/UX designer with a
              ...
              <p className="my-1 font-medium">
                - Full Name : <span className="font-bold">Nguyen Van Ngoc</span>
              </p>
              <p className="my-1 font-medium">
                - Age : <span className="font-bold">21+</span>
              </p>
              <p className="my-1 font-medium">
                - Sex : <span className="font-bold">Male</span>
              </p>
              <p className="my-1 font-medium">
                - National : <span className="font-bold">VietNam</span>
              </p>
              <p className="my-1 font-medium">
                - Address :{" "}
                <span className="font-bold">
                  Thai Thuy-Le Thuy-Quang Binh-VietNam
                </span>
              </p>
            </div>
